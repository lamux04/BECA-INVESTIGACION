...
#SBATCH --mem=200GB
#SBATCH --output=/home/inginf/u32902122/TFG/04_experimentos/logs/out/output_CIC17__clean_dataset__v1.log
#SBATCH --mail-user=javier.labradormunoz@alum.uca.es
#SBATCH --mail-type=BEGIN,END,FAIL,TIME_LIMIT_80

NOMBRE_SCRIPT="CIC17__clean_dataset__v1"
PATH_SCRIPT=03_codigo/CIC17/01_clean_dataset/$NOMBRE_SCRIPT
