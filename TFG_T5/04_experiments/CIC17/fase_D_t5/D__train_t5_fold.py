"""Entrena y evalua T5 con RobustScaler y PCA para un fold de CIC17."""
...
def main():
    ...
    config = {
        ...
        "fold": args.fold,
        "label_col": LABEL_COL,
        "phase_dir_name": "fase_D_t5",
        "phase_label": "D_t5",
        "experiment_name_template": "D__t5_fold_{fold}",
        "feature_pipeline": "robust_scaler_pca_concat",
