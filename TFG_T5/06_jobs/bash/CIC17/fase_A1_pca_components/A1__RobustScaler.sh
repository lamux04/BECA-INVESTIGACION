#!/bin/bash
#SBATCH --job-name=CIC17_A1_ROBUST
...
PYTHON_SCRIPT="$BASE_DIR/04_experiments/CIC17/fase_A1_pca_components/A1__RobustScaler.py"
...
echo "Ejecutando experimento A1 RobustScaler..."
