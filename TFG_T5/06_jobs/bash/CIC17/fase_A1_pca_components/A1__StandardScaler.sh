#!/bin/bash
#SBATCH --job-name=CIC17_A1_STANDARD
#SBATCH --cpus-per-task=64
#SBATCH --partition=normal
#SBATCH --time=1-00:00:00
#SBATCH --mem=200GB
#SBATCH --output=06_jobs/logs/CIC17/fase_A1_pca_components/slurm_%x_%j.out
...
PYTHON_SCRIPT="$BASE_DIR/04_experiments/CIC17/fase_A1_pca_components/A1__StandardScaler.py"
NOMBRE_SCRIPT="$(basename "$PYTHON_SCRIPT" .py)"
LOG_OUT_DIR="$BASE_DIR/06_jobs/logs/CIC17/fase_A1_pca_components"
...
echo "Ejecutando experimento A1 StandardScaler..."
