...
PYTHON_SCRIPT="$BASE_DIR/04_experiments/CIC17/fase_B_t5/B__train_t5_fold.py"
MODEL_PATH="$BASE_DIR/07_models/pretrained/t5-small"
LOG_DIR="$BASE_DIR/06_jobs/logs/CIC17/fase_B_t5"
JOB_ID="${SLURM_JOB_ID:-$(date +"%Y%m%d_%H%M%S")}"
LOG_FILE="$LOG_DIR/output_B__train_t5_fold_${FOLD}_${JOB_ID}.log"
NVIDIA_CSV="$LOG_DIR/nvidia_B__train_t5_fold_${FOLD}_${JOB_ID}.csv"
NVIDIA_TXT="$LOG_DIR/nvidia_B__train_t5_fold_${FOLD}_${JOB_ID}.txt"
...
echo "Entrenando T5 con el fold $FOLD..."
