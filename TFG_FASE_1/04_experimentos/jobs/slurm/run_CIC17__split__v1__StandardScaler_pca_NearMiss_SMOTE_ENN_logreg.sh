#!/bin/bash
#SBATCH --job-name=CIC17__split__v1__StandardScaler_pca_NearMiss_SMOTE_ENN_logreg
#SBATCH --cpus-per-task=64
#SBATCH --partition=normal
#SBATCH --time=1-00:00:00
#SBATCH --mem=200GB
#SBATCH --output=/home/inginf/u32902122/TFG/04_experimentos/logs/out/output_CIC17__split__v1__StandardScaler_pca_NearMiss_SMOTE_ENN_logreg.log
#SBATCH --mail-user=javier.labradormunoz@alum.uca.es
#SBATCH --mail-type=BEGIN,END,FAIL,TIME_LIMIT_80

set -e

NOMBRE_SCRIPT="CIC17__split__v1__StandardScaler_pca_NearMiss_SMOTE_ENN_logreg"
PATH_SCRIPT="03_codigo/CIC17/03_StandardScaler_logreg/CIC17__split__v1__StandardScaler_pca_NearMiss_SMOTE_ENN_logreg"
