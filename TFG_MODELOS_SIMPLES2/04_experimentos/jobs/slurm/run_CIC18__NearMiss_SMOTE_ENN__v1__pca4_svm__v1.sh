#!/bin/bash
#SBATCH --job-name=CIC18__NearMiss_SMOTE_ENN__v1__pca4_svm__v1
#SBATCH --cpus-per-task=64
#SBATCH --partition=normal
#SBATCH --time=1-00:00:00
#SBATCH --mem=200GB
#SBATCH --output=/home/inginf/u32902122/TFG/04_experimentos/logs/out/output_CIC18__NearMiss_SMOTE_ENN__v1__pca4_svm__v1.log
#SBATCH --mail-user=javier.labradormunoz@alum.uca.es
#SBATCH --mail-type=BEGIN,END,FAIL,TIME_LIMIT_80

set -e

NOMBRE_SCRIPT="CIC18__NearMiss_SMOTE_ENN__v1__pca4_svm__v1"
PATH_SCRIPT="03_codigo/CIC18/04_cv_svm/$NOMBRE_SCRIPT"
