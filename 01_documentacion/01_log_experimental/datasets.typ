...
En este documento irá información sobre todos los datasets que vaya generando.
...
#table(
  ...
  [*Nombre dataset*], [*Dataset Base*], [*Dataset anterior*], [*Transformaciones*], [*Script que lo genera*], [*Fecha*], [*Notas*],
)