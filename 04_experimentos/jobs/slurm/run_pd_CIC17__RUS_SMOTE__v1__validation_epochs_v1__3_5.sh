#!/bin/bash
#SBATCH --job-name=pd_CIC17__RUS_SMOTE__v1__validation_epochs_v1__3_5
#SBATCH --cpus-per-task=64
#SBATCH --partition=normal
#SBATCH --time=1-00:00:00
#SBATCH --mem=200GB
#SBATCH --output=/home/inginf/u32902122/TFG/04_experimentos/logs/out/output_pd_CIC17__RUS_SMOTE__v1__validation_epochs_v1__3_5.log
#SBATCH --mail-user=javier.labradormunoz@alum.uca.es
#SBATCH --mail-type=BEGIN,END,FAIL,TIME_LIMIT_80

NOMBRE_SCRIPT="pd_CIC17__RUS_SMOTE__v1__validation_epochs_v1__3_5"
