#!/bin/bash
#SBATCH --job-name=pd_BCCC17__RUS_SMOTE_ENN__v1__training_v1__1_5
#SBATCH --cpus-per-task=64
#SBATCH --partition=gpu
#SBATCH --gres=gpu:1
#SBATCH --time=1-00:00:00
#SBATCH --mem=200GB
#SBATCH --output=/home/inginf/u32902122/TFG/04_experimentos/logs/out/output_pd_BCCC17__RUS_SMOTE_ENN__v1__training_v1__1_5.log
#SBATCH --mail-user=javier.labradormunoz@alum.uca.es
#SBATCH --mail-type=BEGIN,END,FAIL,TIME_LIMIT_80

NOMBRE_SCRIPT="pd_BCCC17__RUS_SMOTE_ENN__v1__training_v1__1_5"
