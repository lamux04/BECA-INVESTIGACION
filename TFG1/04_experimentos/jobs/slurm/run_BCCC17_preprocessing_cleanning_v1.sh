#!/bin/bash
#SBATCH --job-name=BCCC17_preprocessing_cleanning
#SBATCH --cpus-per-task=64
#SBATCH --partition=normal 
#SBATCH --time=1-00:00:00
#SBATCH --mem=200GB
#SBATCH --output=/home/inginf/u32902122/TFG/04_experimentos/logs/out/output_BCCC17_preprocessing_cleanning_v1.log
#SBATCH --mail-user=javier.labradormunoz@alum.uca.es
#SBATCH --mail-type=BEGIN,END,FAIL,TIME_LIMIT_80

NOMBRE_SCRIPT="BCCC17_preprocessing_cleanning_v1"
PATH_SCRIPT=03_codigo/BCCC17/preprocessing/$NOMBRE_SCRIPT
