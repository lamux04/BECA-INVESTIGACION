#!/bin/bash
#SBATCH --job-name=CIC18__split__v1__StandardScaler_sin_pca_RUS_SMOTE_knn
#SBATCH --cpus-per-task=64
#SBATCH --partition=normal
#SBATCH --time=1-00:00:00
#SBATCH --mem=200GB
#SBATCH --output=/home/inginf/u32902122/TFG/04_experimentos/logs/out/output_CIC18__split__v1__StandardScaler_sin_pca_RUS_SMOTE_knn.log
#SBATCH --mail-user=javier.labradormunoz@alum.uca.es
#SBATCH --mail-type=BEGIN,END,FAIL,TIME_LIMIT_80

set -e

NOMBRE_SCRIPT="CIC18__split__v1__StandardScaler_sin_pca_RUS_SMOTE_knn"
PATH_SCRIPT="03_codigo/CIC18/03_StandardScaler_knn/CIC18__split__v1__StandardScaler_sin_pca_RUS_SMOTE_knn"
