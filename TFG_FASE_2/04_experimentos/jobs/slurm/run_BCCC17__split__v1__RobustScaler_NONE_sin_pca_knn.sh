#!/bin/bash
#SBATCH --job-name=BCCC17__split__v1__RobustScaler_NONE_sin_pca_knn
#SBATCH --cpus-per-task=64
#SBATCH --partition=normal
#SBATCH --time=1-00:00:00
#SBATCH --mem=200GB
#SBATCH --output=/home/inginf/u32902122/TFG/04_experimentos/logs/out/output_BCCC17__split__v1__RobustScaler_NONE_sin_pca_knn.log
#SBATCH --mail-user=javier.labradormunoz@alum.uca.es
#SBATCH --mail-type=BEGIN,END,FAIL,TIME_LIMIT_80

set -e

NOMBRE_SCRIPT="BCCC17__split__v1__RobustScaler_NONE_sin_pca_knn"
PATH_SCRIPT="03_codigo/BCCC17/03_RobustScaler_knn/BCCC17__split__v1__RobustScaler_NONE_sin_pca_knn"
