...
#SBATCH --mem=200GB
#SBATCH --job-name=03-preparing-dataset
#SBATCH --output=/home/inginf/u32902122/TFG/Scripts/Experimento-B2/03-preparing-dataset-output.log
#SBATCH --mail-user=javier.labradormunoz@alum.uca.es
#SBATCH --mail-type=BEGIN,END,FAIL,TIME_LIMIT_80

NOMBRE_PASO="03-preparing-dataset"
BASE=/home/inginf/u32902122/TFG/Scripts/Experimento-B2/$NOMBRE_PASO
NOTEBOOK=$BASE.ipynb
